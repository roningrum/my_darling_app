...
const Color primaryColor = Color(0xff303841);
const Color secondaryColor = Color(0xff3A4750);
const Color redColor = Color(0xffD72323);
const Color whiteColor = Colors.white;
const Color greyColor = Color(0xffEEEEEE);

const Color redOther = Color(0xffFF5A5A);
const Color blueOther = Color(0xff046EB7);
const Color greenOther = Color(0xff04AD58);
